            ...
            <div>
                ...
                <form id="AgregarPersona">
                    <ul>
                        ...
                        <label htmlFor="addNombre"> <strong>Nombre:</strong></label>
                            <br></br>
                            <input type="text" id="addNombre" name="nombre" onChange={this.handleChange}></input>
                        </li>
                        <li className="form-group">
                            <label htmlFor="addDocumento"> <strong>Documento:</strong></label>
                                <br></br>
...
function MenuAgregarReclamo(){
    ReactDOM.render(<AddReclamo/>, document.getElementById('container'));
}

class AddReclamo extends React.Component{
    constructor(props){
        super(props);
        this.handleSubmit=this.handleSubmit.bind(this);
        this.handleChange=this.handleChange.bind(this);
    ...
    handleChange(event){
        this.setState({
            clicked: true,
            sCodigo: document.getElementById('addCodigo').value,
            sPiso: document.getElementById('addPiso').value,
            sNumero: document.getElementById('addNumero').value,
            sDocumento: document.getElementById('addDocumento').value,
            sUbicacion: document.getElementById('addUbicacion').value,
            sDescripcion: document.getElementById('addDescripcion').value
        });
    ...
    handleSubmit(event){
        console.log(this.state.sNombre);
        console.log(this.state.sDocumento);
        var url = 'http://localhost:8080/ar/agregarReclamo?codigo=' + this.state.sCodigo + '&piso=' + this.state.sPiso + "&numero=" + this.state.sNumero + "&documento=" + 
        this.state.sDocumento + "&ubicacion=" + this.state.sUbicacion + "&descripcion=" + this.state.sDescripcion;
        if(this.state.clicked){
            axios.post(url)
          .then(function (response) {
            console.log(response);
        ...
        return(
            <div>
                ...
                <form id="AgregarReclamo">
                    <ul>
                        <li className="form-group">
                        <label htmlFor="addCodigo"> <strong>Codigo:</strong></label>
                            <br></br>
                            <input type="text" id="addCodigo" name="codigo" onChange={this.handleChange}></input>
                        </li>
                        <li className="form-group">
                            <label htmlFor="addPiso"> <strong>Piso:</strong></label>
                                <br></br>
                            <input type="text" id="addPiso" name="piso" onChange={this.handleChange}></input>
                        </li>
                        <li className="form-group">
                            <label htmlFor="addNumero"> <strong>Numero:</strong></label>
                                <br></br>
                            <input type="text" id="addNumero" name="Numero" onChange={this.handleChange}></input>
                        </li>
                        <li className="form-group">
                            <label htmlFor="addDocumento"> <strong>Documento:</strong></label>
                                <br></br>
                        ...
                        <li className="form-group">
                            <label htmlFor="addUbicacion"> <strong>Ubicacion:</strong></label>
                                <br></br>
                            <input type="text" id="addUbicacion" name="ubicacion" onChange={this.handleChange}></input>
                        </li>
                        <li className="form-group">
                            <label htmlFor="addDescripcion"> <strong>Descripcion:</strong></label>
                                <br></br>
                            <input type="text" id="addDescripcion" name="descripcion" onChange={this.handleChange}></input>
                        </li>
